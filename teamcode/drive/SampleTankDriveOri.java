 ...
 * This is the original un-modified SampleTankDrive code.
 */
@Config
public class SampleTankDriveOri extends TankDrive {
    ...
    public SampleTankDriveOri(HardwareMap hardwareMap) {
